...
# Debugger Context Menus
BreakpointsWindow.Delete (-) Alt+F9, D
BreakpointsWindow.GoToDisassembly (-) Alt+F9, A
BreakpointsWindow.GoToSourceCode (-) Alt+F9, S
# Diagnostics Hub
StopCollection (-) Ctrl+Alt+F2
# Edit
Copy (-) Ctrl+C or Ctrl+Ins
Cut (-) Ctrl+X or Shift+Delete
CycleClipboardRing (-) Ctrl+Shift+V or Ctrl+Shift+Ins
Delete (-) Delete
Find (-) Ctrl+F
FindAllReferences (-) Shift+F12
FindinFiles (-) Ctrl+Shift+F
FindNext (-) F3
FindNextSelected (-) Ctrl+F3
FindPrevious (-) Shift+F3
FindPreviousSelected (-) Ctrl+Shift+F3
GenerateMethod (-) Ctrl+K, Ctrl+M
GoTo (-) Ctrl+G
GoToDeclaration (-) Ctrl+F12
GoToDefinition (-) F12
GoToFindCombo (-) Ctrl+D
GoToNextLocation (-) F8
GoToPrevLocation (-) Shift+F8
InsertSnippet (-) Ctrl+K, Ctrl+X
MoveControlDown (-) Ctrl+Down Arrow
MoveControlDownGrid (-) Down Arrow
MoveControlLeft (-) Ctrl+Left Arrow
MoveControlLeftGrid (-) Left Arrow
MoveControlRight (-) Ctrl+Right Arrow
MoveControlRightGrid (-) Right Arrow
MoveControlUp (-) Ctrl+Up Arrow
MoveControlUpGrid (-) Up Arrow
NavigateTo (-) Ctrl+,
NextBookmark (-) Ctrl+K, Ctrl+N
NextBookmarkInFolder (-) Ctrl+Shift+K, Ctrl+Shift+N
OpenFile (-) Ctrl+Shift+G
Paste (-) Ctrl+V or Shift+Ins
PreviousBookmark (-) Ctrl+K, Ctrl+P
PreviousBookmarkInFolder (-) Ctrl+Shift+K, Ctrl+Shift+P
QuickFindSymbol (-) Shift+Alt+F12
Redo (-) Ctrl+Y or Ctrl+Shift+Z or Shift+Alt+Backspace
RefreshRemoteReferences (-) Ctrl+Shift+J
Replace (-) Ctrl+H
ReplaceinFiles (-) Ctrl+Shift+H
SelectAll (-) Ctrl+A
SelectNextControl (-) Tab
SelectPreviousControl (-) Shift+Tab
ShowTileGrid (-) Enter
SizeControlDown (-) Ctrl+Shift+Down Arrow
SizeControlDownGrid (-) Shift+Down Arrow
SizeControlLeft (-) Ctrl+Shift+Left Arrow
SizeControlLeftGrid (-) Shift+Left Arrow
SizeControlRight (-) Ctrl+Shift+Right Arrow
SizeControlRightGrid (-) Shift+Right Arrow
SizeControlUp (-) Ctrl+Shift+Up Arrow
SizeControlUpGrid (-) Shift+Up Arrow
StopSearch (-) Alt+F3, S
SurroundWith (-) Ctrl+K, Ctrl+S
...
NewWebSite (-) Shift+Alt+N
OpenFile (-) Ctrl+O (letter 'O')
OpenProject (-) Ctrl+Shift+O (letter 'O')
OpenWebSite (-) Shift+Alt+O (letter 'O')
Print (-) Ctrl+P
SaveAll (-) Ctrl+Shift+S
SaveSelectedItems (-) Ctrl+S
ViewinBrowser (-) Ctrl+Shift+W
# Help
AddandRemoveHelpContent (-) Ctrl+Alt+F1
F1Help (-) F1
ViewHelp (-) Ctrl+F1
WindowHelp (-) Shift+F1
# Load Test
JumpToCounterPane (-) Ctrl+R, Q
# Other Context Menus
MicrosoftDataEntityDesignContext.AddNewDiagram (-) Insert
# Project
AddExistingItem (-) Shift+Alt+A
AddNewItem (-) Ctrl+Shift+A
ClassWizard (-) Ctrl+Shift+X
...
# Project and solution context menus
Item.MoveDown (-) Alt+Down Arrow
Item.MoveUp (-) Alt+Up Arrow
# Refactor
EncapsulateField (-) Ctrl+R, Ctrl+E
ExtractInterface (-) Ctrl+R, Ctrl+I
ExtractMethod (-) Ctrl+R, Ctrl+M
RemoveParameters (-) Ctrl+R, Ctrl+V
Rename (-) Ctrl+R, Ctrl+R
ReorderParameters (-) Ctrl+R, Ctrl+O (letter 'O')
# Solution Explorer
OpenFilesFilter (-) Ctrl+[, O (letter 'O') or Ctrl+[, Ctrl+O (letter 'O') 
PendingChangesFilter (-) Ctrl+[, P or Ctrl+[, Ctrl+P
SyncWithActiveDocument (-) Ctrl+[, S or Ctrl+[, Ctrl+S
# Team
Git.GoToGitBranches (-) Ctrl+0 (zero), Ctrl+N or Ctrl+0, N
Git.GoToGitChanges (-) Ctrl+0 (zero), Ctrl+G or Ctrl+0, G
Git.GoToGitCommits (-) Ctrl+0 (zero), Ctrl+O (letter 'O') or Ctrl+0, O
TeamExplorerSearch (-) Ctrl+'
# Team Foundation Context Menus
Commands.GoToBuilds (-) Ctrl+0 (zero), Ctrl+B or Ctrl+0, B
Commands.GoToConnect (-) Ctrl+0 (zero), Ctrl+C or Ctrl+0, C
Commands.GoToDocuments (-) Ctrl+0 (zero), Ctrl+D or Ctrl+0, D
Commands.GoToHome (-) Ctrl+0 (zero), Ctrl+H or Ctrl+0, H
Commands.GoToMyWork (-) Ctrl+0 (zero), Ctrl+M or Ctrl+0, M
Commands.GoToPendingChanges (-) Ctrl+0 (zero), Ctrl+P or Ctrl+0, P
Commands.GoToReports (-) Ctrl+0 (zero), Ctrl+R or Ctrl+0, R
Commands.GoToSettings (-) Ctrl+0 (zero), Ctrl+S or Ctrl+0, S
Commands.GoToWebAccess (-) Ctrl+0 (zero), Ctrl+A or Ctrl+0, A
Commands.GoToWorkItems (-) Ctrl+0 (zero), Ctrl+W or Ctrl+0, W
# Test
UseCodedUITestBuilder (-) Ctrl+\, Ctrl+C
UseExistingActionRecording (-) Ctrl+\, Ctrl+A
# Test Explorer
DebugAllTests (-) Ctrl+R, Ctrl+A
DebugAllTestsInContext (-) Ctrl+R, Ctrl+T
RepeatLastRun (-) Ctrl+R, L
RunAllTests (-) Ctrl+R, A
RunAllTestsInContext (-) Ctrl+R, T
# Tools
AttachtoProcess (-) Ctrl+Alt+P
CodeSnippetsManager (-) Ctrl+K, Ctrl+B
ForceGC (-) Ctrl+Shift+Alt+F12, Ctrl+Shift+Alt+F12
GoToCommandLine (-) Ctrl+/
# View
AllWindows (-) Shift+Alt+M
ArchitectureExplorer (-) Ctrl+\, Ctrl+R
Backward (-) Alt+Left Arrow
BookmarkWindow (-) Ctrl+K, Ctrl+W
BrowseNext (-) Ctrl+Shift+1
BrowsePrevious (-) Ctrl+Shift+2
CallHierarchy (-) Ctrl+Alt+K
ClassView (-) Ctrl+Shift+C
ClassViewGoToSearchCombo (-) Ctrl+K, Ctrl+V
CodeDefinitionWindow (-) Ctrl+\, D or Ctrl+\, Ctrl+D
CommandWindow (-) Ctrl+Alt+A
DataSources (-) Shift+Alt+D
DocumentOutline (-) Ctrl+Alt+T
EditLabel (-) F2
ErrorList (-) Ctrl+\, E or Ctrl+\, Ctrl+E
F#Interactive (-) Ctrl+Alt+F
FindSymbolResults (-) Ctrl+Alt+F12
Forward (-) Alt+Right Arrow
ForwardBrowseContext (-) Ctrl+Shift+7
FullScreen (-) Shift+Alt+Enter
NavigateBackward (-) Ctrl+-
NavigateForward (-) Ctrl+Shift+-
NextError (-) Ctrl+Shift+F12
Notifications (-) Ctrl+W, N or Ctrl+W, Ctrl+N
ObjectBrowser (-) Ctrl+Alt+J
ObjectBrowserGoToSearchCombo (-) Ctrl+K, Ctrl+R
Output (-) Ctrl+Alt+O (letter 'O')
PopBrowseContex (-) Ctrl+Shift+8
PropertiesWindow (-) F4
PropertyPages (-) Shift+F4
ResourceView (-) Ctrl+Shift+E
ServerExplorer (-) Ctrl+Alt+S
ShowSmartTag (-) Shift+Alt+F10 or Ctrl+.
SolutionExplorer (-) Ctrl+Alt+L
SQLServerObjectExplorer (-) Ctrl+\, Ctrl+S
TaskList (-) Ctrl+\, T or Ctrl+\, Ctrl+T
TfsTeamExplorer (-) Ctrl+\, Ctrl+M
Toolbox (-) Ctrl+Alt+X
UMLModelExplorer (-) Ctrl+\, Ctrl+U
ViewCode (-) F7
ViewDesigner (-) Shift+F7
WebBrowser (-) Ctrl+Alt+R
ZoomIn (-) Ctrl+Shift+.
ZoomOut (-) Ctrl+Shift+,
# Window
...
MicrosoftDataEntityDesignContext.MoveProperties.ToTop (-) Alt+Home
MicrosoftDataEntityDesignContext.MoveProperties.Up (-) Alt+Up Arrow
MicrosoftDataEntityDesignContext.MoveProperties.Up5 (-) Alt+PgUp
MicrosoftDataEntityDesignContext.Refactor.Rename (-) Ctrl+R, R
MicrosoftDataEntityDesignContext.RemovefromDiagram (-) Shift+Del
...
View.ViewCode (-) Enter
# Coded UI Text Editor
UITestEditorContextMenu.CopyReferencetoClipboard (-) Ctrl+C
UITestEditorContextMenu.InsertDelayBefore (-) Ctrl+Alt+D
UITestEditorContextMenu.LocateAll (-) Shift+Alt+L
UITestEditorContextMenu.LocatetheUIControl (-) Ctrl+Shift+L
UITestEditorContextMenu.Movecode (-) Ctrl+Alt+C
UITestEditorContextMenu.Splitintoanewmethod (-) Ctrl+Shift+T
# DataSet Editor
ColumnContext.InsertColumn (-) Insert
DbTableContext.Add.Column (-) Ctrl+L
# Difference Viewer
IgnoreTrimWhitespace (-) Ctrl+\, Ctrl+Spacebar
InlineView (-) Ctrl+\, Ctrl+1
LeftOnlyView (-) Ctrl+\, Ctrl+3
NextDifference (-) F8
PreviousDifference (-) Shift+F8
RightOnlyView (-) Ctrl+\, Ctrl+4
SideBySideView (-) Ctrl+\, Ctrl+2
SwitchBetweenLeftAndRight (-) Ctrl+\, Ctrl+Tab
SynchronizeViewToggle (-) Ctrl+\, Ctrl+Down Arrow
EditorContextMenus.CodeWindow.AddComment (-) Ctrl+Shift+K
EditorContextMenus.CodeWindow.EditLocalFile (-) Ctrl+Shift+P
# DOMExplorer
Refresh (-) F5
SelectElement (-) Ctrl+B
ShowLayout (-) Ctrl+Shift+I
# F# interactive
FSIConsoleContext.CancelInteractiveEvaluation (-) Ctrl+Break
# Graph Document Editor
...
View.ViewCode (-) F7
# Solution Explorer
ClassViewContextMenus.ClassViewView.ViewinPageInspector (-) Ctrl+K, Ctrl+G
# Team Explorer
Edit.Delete (-) Delete
Rename (-) F2
