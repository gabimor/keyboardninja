...
const shortcutController = __importStar(require("./controllers/shortcut"));
const appController = __importStar(require("./controllers/app"));
...
app.get("/app/:id", appController.getApp);
app.post("/shortcut", shortcutController.postShortcut);
/**
 * API examples routes.
 */
